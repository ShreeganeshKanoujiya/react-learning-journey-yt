...
function AddTodos() {
    ...
    return (
        <form onSubmit={addTodoHandler} className="flex gap-3 mb-8">
            ...
            <button
                type="submit"
                className="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg font-semibold transition-colors duration-200"
            >
                Add Todo
            </button>
        </form>
